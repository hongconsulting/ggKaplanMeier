...
fig1 <- ggKM(data$time * 12 / 365.2425, data$status - 1, data$sex, CI = f.custom, breaks.t = seq(0, 30, 6), legend.labels = c("Male", "Female"), title.s = "Overall survival", title.t = "Time (months)")
print(fig1)
```
...
2.  Cox, D.R., 1972. Regression Models and Life-Tables. *Journal of the
    Royal Statistical Society*, Series B. 34(2), pp. 187–220.
3.  Dorey, F.J. and Korn, E.L., 1987. Effective sample sizes for
    confidence intervals for survival probabilities. *Statistics in
    Medicine*, 6(6), pp. 679–687.
4.  Fay, M.P., Brittain, E.H. and Proschan, M.A., 2013. Pointwise
...
6.  Hollander, M. and McKeague, I.W., 1997. Likelihood ratio-based
...
8.  Nair, V.N., 1984. Conﬁdence bands for survival functions with
    censored data: a comparative study. *Technometrics*, 26,
    pp. 265–275.
9.  Rothman, K.J., 1978. Estimation of confidence limits for the
    cumulative probability of survival in life table analysis. *Journal
    of Chronic Diseases*, 31(8), pp. 557–560.
10. Thomas, D.R. and Grunkemeier, G.L., 1975. Confidence interval
